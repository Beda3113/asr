...
def get_dataloaders(config, text_encoder, device):
    ...
    if hasattr(config, 'transforms') and hasattr(config.transforms, 'batch_transforms'):
    ...
    for dataset_partition in config.datasets.keys():
        ...
        # Convert OmegaConf to dict for instance_transforms if needed
        instance_transforms = None
        if 'instance_transforms' in dataset_config and dataset_config.instance_transforms is not None:
            instance_transforms = instantiate(dataset_config.instance_transforms)
        ...
        partition_dataloader = DataLoader(
            ...
            shuffle=(dataset_partition == "train") and config.dataloader.shuffle,
